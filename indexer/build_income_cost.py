...
NEW_CFG = (
    ...
    '    "번호이동수수료": ["FC70","FC79"],\n'
    '    "고객충성제도":   ["FC70"],\n'
    '    /* ─── 매출에누리·매출할인 (요금수익 차감, 음수 계정) ─── */\n'
    '    "매출에누리":     ["FC70","FC71","FC72"],\n'
    '    "매출할인":       ["FC70","FC71","FC72"],\n'
    '    /* ─── 도매제공수익 (MVNO 관련은 특수 — MVNO 키워드 있으면 FC74 자동 추가) ─── */\n'
    '    "도매제공수익":   ["FC74"],\n'
    '    "도매수익":       ["FC74"],\n'
    '    "MVNO":           ["FC74","FC70"],\n'
    '    /* ─── 내부거래수익 ─── */\n'
...
NEW_R2 = (
    ...
    '      /* 긴 키워드부터 확인 (요금수익 > 수익). 매출에누리는 최우선 (원 계정 차감이므로 요금수익 형태 허용) */\n'
    ...
    '          allowed = cfg.ACCT_NAME_FORM[kwSorted[kwi]].slice();  /* 복사본 */\n'
    '          matchedBy = "계정명 키워드 [" + kwSorted[kwi] + "]";\n'
    '          break;\n'
    '        }\n'
    '      }\n'
    '      /* 특수 처리: 계정명에 "MVNO"가 있으면 도매제공수익(FC74) 형태도 자동 허용 */\n'
    '      if (allowed && acctName.indexOf("MVNO") >= 0 && allowed.indexOf("FC74") < 0){\n'
    '        allowed.push("FC74");\n'
    '        matchedBy += " + MVNO(도매제공수익 허용)";\n'
    '      }\n'
    '    }\n'
